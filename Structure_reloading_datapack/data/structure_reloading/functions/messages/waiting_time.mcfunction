...
$title @s subtitle ["",{"text":"Patienter ","color":"dark_blue"},{"score":{"name":"@e[type=marker,name=sr_timeStructure,scores={sr_idZone=$(idZone)},distance=..0.1,limit=1]","objective":"sr_nb"},"color":"blue"},{"text":"s ","color":"blue"},{"text":"avant la restauration","color":"dark_blue"}]
title @s title [""]
